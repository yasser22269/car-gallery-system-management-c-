...
namespace WindowsFormsApplication3
{
    public partial class BuyCar : Form
    {
        ...
        public string name;
        public BuyCar(int id,string name,int userType)
        {
            this.id = id;
        ...
        private void ADD_Click(object sender, EventArgs e)
        {
                ...
                && textBox3.Text != "" && textBox4.Text != "" && textBox5.Text !="")
            {
                ...
                SqlCommand command = new SqlCommand("insert orders(user_id,car_id) values('"
                + id + "','" + textBox5.Text + "')", con);
                ...
                if (i > 0)
                {
                    MessageBox.Show("تم الارسال بنجاح يرجى الانتظار حتى الموافقه");
                    clearData();
                    views();
                }
                else
